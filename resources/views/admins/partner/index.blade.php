                ...
                <tbody>
                    ...
                    @foreach($slider as $data)
                        <tr>
                            <td>{{$useId}}</td>
                            <td>
                            <img src="{{asset('public/storage/partner/img/'.$data->partner_image)}}" class="img-fluid" alt="user" style="height: 40px; width:40px;  border-radius: 50%;">

                            </td>
                            <td>{{$data->partner_url}}</td>
                            <td>
                                <a href="{{asset('admin/partner/edit/'.$data->id)}}"   id="editbutton"><i class="fas fa-edit text-warning" aria-hidden="true" style="font-size:18px" data-bs-toggle="modal" data-bs-target="#edituser"></i></a>
