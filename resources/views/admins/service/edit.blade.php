                 ...
                 <div class="col-12 col-xl-8">
                    ...
                    <div class="card mb-4">
                        <div class="card-body p-4">
                            <form  action="{{route('service.store')}}" method="POST" class=" btn-submit user_add form-horizontal" enctype="multipart/form-data">
                                @csrf
                                ...
                                <div class="form-group">
                                    <label class="col-sm control-label">Service Image</label>
                                    <div class="mb-3">
                                    <img src="{{url('public/storage/service/img/'.$slider->image_name)}}" class="img-fluid" alt="user" style="height: 40px; width:40px;  border-radius: 50%;">
                                        <input class="form-control" name="image_name" type="file" id="formFile"  class="img-fluid" value="{{$slider->image_name}}"  accept=".png, .jpg, .jpeg"> 
