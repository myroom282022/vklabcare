                 ...
                 <div class="col-12 col-xl-8">
                    ...
                    <div class="card mb-4">
                        <div class="card-body p-4">
                            <form  action="{{route('contact-info.store')}}" method="POST" class=" btn-submit user_add form-horizontal" enctype="multipart/form-data">
                                @csrf
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-12">
                                        <input type="text" class="form-control" id="phone" name="phone" placeholder="1234567890" value="{{old('phone')}}">
                                        @if ($errors->has('phone'))
