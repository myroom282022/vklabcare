                        ...
                        <div class="card-body p-4">
                            <form id="create" action="{{route('package.store')}}" method="POST" class=" btn-submit user_add form-horizontal" enctype="multipart/form-data">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            <label for="name" class="col-sm control-label">Package Category Name</label>
                                            <div class="col-sm-12">
                                                @if($package)
                                                <select class="form-control" name="package_category_name">
                                                <option value="" selected>------------ Select Package category name -------------</option>
                                                    @foreach($package as $value)
                                                         <option value="{{$value->package_category_name}}" >{{$value->package_category_name}}</option>
                                                    @endforeach
                                                </select>
                                                @endif
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-12">
                                                <input type="text" readonly class="form-control" id="package_discount_percentage" name="package_discount_percentage" placeholder="Enter package discount price"   value="{{ old('package_discount_price') }}">
                               ...
                               <div class="row">
                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-12">
                                                <textarea  class="form-control" rows="5" id="package_description" name="package_description" placeholder="Enter description">{{ old('package_description') }}</textarea>
