...
@endphp
  ...
  <link rel="stylesheet" href="{{asset('front_assets/plugins/slick-carousel/slick/slick.css')}}">
  <link rel="stylesheet" href="{{asset('front_assets/plugins/slick-carousel/slick/slick-theme.css')}}">
...
<header class="">
 ...
 <!-- 
    ...
    <script src="{{asset('front_assets/plugins/jquery/jquery.js')}}"></script>
    <script src="{{asset('front_assets/plugins/bootstrap/bootstrap.min.js')}}"></script>
    <script src="{{asset('front_assets/plugins/slick-carousel/slick/slick.min.js')}}"></script>
