		...
		<div class="row">
			<div class="col-lg-4 col-md-6 ">
				<div class="department-block mb-5">
					<img src="{{url('front_assets/images/service/service-1.jpg')}}" alt="" class="img-fluid w-100">
					<div class="content">
			...
			<div class="col-lg-4 col-md-6">
				<div class="department-block mb-5">
					<img src="{{url('front_assets/images/service/service-2.jpg')}}" alt="" class="img-fluid w-100">
					<div class="content">
			...
			<div class="col-lg-4 col-md-6">
				<div class="department-block mb-5">
					<img src="{{url('front_assets/images/service/service-3.jpg')}}" alt="" class="img-fluid w-100">
					<div class="content">
			...
			<div class="col-lg-4 col-md-6 ">
				<div class="department-block  mb-5 mb-lg-0">
					<img src="{{url('front_assets/images/service/service-4.jpg')}}" alt="" class="img-fluid w-100">
					<div class="content">
			...
			<div class="col-lg-4 col-md-6">
				<div class="department-block mb-5 mb-lg-0">
					<img src="{{url('front_assets/images/service/service-6.jpg')}}" alt="" class="img-fluid w-100">
					<div class="content">
			...
			<div class="col-lg-4 col-md-6">
				<div class="department-block mb-5 mb-lg-0">
					<img src="{{url('front_assets/images/service/service-8.jpg')}}" alt="" class="img-fluid w-100">
					<div class="content">
