		...
		<div class="comment-area mt-4 mb-5">
			...
			<ul class="comment-tree list-unstyled">
				<li class="mb-5">
					<div class="comment-area-box d-block d-sm-flex">
						<div class="comment-thumb">
							<img alt="" src="{{asset('public/front_assets/images/blog/testimonial1.jpg')}}" style="width: 70px">
						</div>
				...
				<li>
					<div class="comment-area-box d-block d-sm-flex">
						<div class="comment-thumb">
							<img alt="" src="{{asset('public/front_assets/images/blog/testimonial2.jpg')}}" style="width: 70px">
						</div>
