	...
	<div class="container">
		<div class="row">
			...
			<div class="col-lg-8">
				...
				<img src="{{url('public/front_assets/images/about/sign.png')}}" alt="" class="img-fluid">
			</div>
		</div>
	</div>
</section>
		...
		<div class="row">
			<div class="col-lg-3 col-md-6">
				<div class="about-block-item mb-5 mb-lg-0">
					<img src="{{url('public/front_assets/images/about/about-1.jpg')}}" alt="" class="img-fluid w-100">
			...
			<div class="col-lg-3 col-md-6">
				<div class="about-block-item mb-5 mb-lg-0">
					<img src="{{url('public/front_assets/images/about/about-2.jpg')}}" alt="" class="img-fluid w-100">
			...
			<div class="col-lg-3 col-md-6">
				<div class="about-block-item mb-5 mb-lg-0">
					<img src="{{url('public/front_assets/images/about/about-3.jpg')}}" alt="" class="img-fluid w-100">
			...
			<div class="col-lg-3 col-md-6">
				<div class="about-block-item">
					<img src="{{url('public/front_assets/images/about/about-4.jpg')}}" alt="" class="img-fluid w-100">
...
<section class="section team">
	<div class="container">
		...
		<div class="row">
			...
			<div class="col-lg-3 col-md-6 col-sm-6">
				<div class="team-block mb-5 mb-lg-0">
					<img src="{{url('public/front_assets/images/team/2.jpg')}}" alt="" class="img-fluid w-100">
			...
			<div class="col-lg-3 col-md-6 col-sm-6">
				<div class="team-block mb-5 mb-lg-0">
					<img src="{{url('public/front_assets/images/team/3.jpg')}}" alt="" class="img-fluid w-100">
