@extends('users_panel.Auth.layout')
	...
	<div class="container d-flex justify-content-center">
		<div class="container height-100 d-flex justify-content-center align-items-center"> 
			<div class="position-relative"> <div class="card p-2 text-center"> 
				...
				@php 
				$phoneNumberDeegits=substr($user->phone, -4);
				@endphp
				...
				<form method="post"  id="form">
					...
					<input type="hidden" name="twilio_otp" id="twilio_otp" value="">
	...
	$("#form").submit(function(e){
		...
		$.ajax({
			...
			$.each( res.errors,function (k,v) {
					toastr.error(res.error,v);
			});
			}else{
				if(res.access_token != ''){  
					toastr.success(res.success,"User has been verified!");
	...
	$("#resetOtp").click(function(e){
		...
		$.ajax({
			...
			$.each( res.errors,function (k,v) {
				...
				if(res.access_token != ''){  
					toastr.success(res.success,"OTP has sent on your phone !");
				}
			}
		});
